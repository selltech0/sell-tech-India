        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="/admin.php" class="h5 text-white">Admin Panel </a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <p>An admin panel enables administrators of an application, website, or IT system to manage its configurations, settings, content, and features and carry out oversight functions critical to the business. It allows them to view the state of the platform and take any action in the performance of their duties.</p>
                        <p>Developing an admin panel is a unique software design challenge. Businesses often regard it as a secondary consideration because it’s not meant for end-users. However, giving your platform administrators the right tools is a critical lever in delivering a seamless user experience for your customers.</p>
                        <p></p>
