...
<head>
    ...
    <link rel="stylesheet" href="/hh/css/s.css">
...
<body>
    ...
    <div class="form">
        ...
        <input type="submit" value="register" class="btn" onclick="openpopup()" name="register">
        <a href="/hh/login.php" class="link" target="_blank">already have an account ? log in here</a>
    </div>
    </form>
...
.popup button{
    ...
    <script src="/hh/js/form.js"></script>
...
<?php 
    ...
    if($_POST["register"])
    {
        ...
        $query = "INSERT INTO signupform values('$name','$email','$pass')";
