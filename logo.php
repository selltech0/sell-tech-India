        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <a href="/logo.php" class="h5 text-white">Logo and Template Design </a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <h1 class="mb-4">Logo and Template Design </h1>
                        <p>A logo template is a graphic design template that often includes graphic and text elements that can be further manipulated with your company name and colors.</p>
                        <p>A template is typically a vector-based shape and can be adjusted in terms of color and text placements. (Designers who are fluent with tools such as Adobe Illustrator can customize a logo template even further.)</p>
                        <p>Other benefits of a logo template include: <br>

1.Low-cost option <br>
2. Easy to customize <br>
3. What you see is what you get design <br>
4. Plenty of options and style to choose from <br>
5. Most come as vector shapes for scalability <br> 6.Wordmarks/logotypes <br>

7.Letterforms <br>

8.Lettermarks/monogram logos <br>

9.Logo symbols/brand marks/pictorial marks <br>

10.Abstract logo marks <br>

11.Mascots <br>

12.Emblems <br>

13.Combination marks <br>

14.Dynamic Marks</p>
                        <p> <a href="/form order/ORDERForm/order.php" class="btn btn-primary py-2 px-4 mt-4">Order Now</a></p>
                    </div>
                    <!-- Blog Detail End -->
